...
class CcImsiData(models.Model):
    rownum = models.FloatField(db_column='ROWNUM', primary_key=True)  # Field name made lowercase.
    code = models.CharField(max_length=45)
    date = models.CharField(max_length=8)
    value = models.FloatField(blank=True, null=True)
...
class ImsiIndexData(models.Model):
...
class StockSisae(models.Model):
    ...
    class Meta:
        ...
        unique_together = (('code', 'date'), ('code', 'date'),)
